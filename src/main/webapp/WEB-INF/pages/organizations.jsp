...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <select class="organization-sorttable-btn form-control input-lg" id="sortByDropDownId"
        ...
        <table id="organizationTable" class="organization-table sortable table table-bordered">
            <tr>
                <th>Name</th>
                <th>Type</th>
                <th>Address</th>
