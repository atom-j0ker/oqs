...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <img class="organization-photo" src="${organization.photo}"/>
        ...
        <c:if test="${username == organization.email}">
            <form action="/organization/${organization.id}/change-photo" method="post" enctype="multipart/form-data">
                ...
                <input id="files" name="files" class="hidden-files" type="file" accept="image/*">
        ...
        <ul id="service-list">
            <c:forEach items="${services}" var="service">
                <li id="li${service.id}" style="margin-left: 50px"><a
                        href="/organization/${organization.id}/service/${service.id}" target="_blank"
        ...
        <c:if test="${username == organization.email}">
            ...
            <div class="mastersSchedule" style="min-height: 50px">
                <span class="simple-text"
                      style="margin-bottom: 20px; margin-top: 15px; margin-right: 25px; float: left">Master's schedule: </span>
                <select id="mastersScheduleDropDown" class="form-control input-lg"
                ...
                success: function (data) {
                    ...
                    if (data.length != 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            tdTime.innerHTML = data[i].simpleTime;
